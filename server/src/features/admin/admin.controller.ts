...
export class AdminController {
	...
	@ApiOperation({
		...
		description:
			'Promotes a user to an admin role. If the user does not exist, a new user with admin role will be created.',
	})
	...
	@ApiOperation({
		...
		description: 'Retrieves comprehensive system statistics for admin dashboard.',
	})
	...
	@ApiOperation({
		...
		description: 'Retrieves daily activity statistics.',
	})
	...
	@ApiOperation({
		...
		description: 'Retrieves post category distribution statistics.',
	})
	...
	@ApiOperation({
		...
		description: 'Retrieves top posts and courses statistics.',
	})
	async getTopContent() {
	...
	@HttpCode(HttpStatus.CREATED)
	@ApiOperation({
		summary: 'Create K-pop demo course',
		description: 'Creates a demo course based on K-pop Demon Hunters filming locations in Seoul.',
	})
